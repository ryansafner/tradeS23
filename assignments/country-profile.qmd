...
- [<i class="fas fa-file-powerpoint"></i> Example Powerpoint (1)](/files/profile/USA-example.pptx) [<i class="fas fa-file-powerpoint"></i> Example Powerpoint (2)](/files/profile/Egypt-example.pptx) [<i class="fas fa-file-powerpoint"></i> Example Powerpoint (3)](/files/profile/Gambia-example.pptx)
- [<i class="fab fa-markdown"></i> Using R to Download World Bank Data (`rmd`)](/files/profile/usa_country_profile_data.Rmd)
- [<i class="fas fa-external-link-square-alt"></i> Using R to Download World Bank Data (`html`)](/files/profile/usa_country_profile_data.html)
