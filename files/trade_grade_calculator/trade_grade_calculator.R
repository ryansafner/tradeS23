        ...
        mainPanel(
           ...
           p("Made with",
             ...
             a("International Trade",
               href="http://trades23.classes.ryansafner.com"),
...
server <- function(input, output) {
    ...
    output$printgrades <- renderText({
        coursegrade<-round(((input$disc*4)+(input$profile*0.10)+(input$hw*0.20)+(input$midterm*0.25)+(input$final*0.25)),4)
