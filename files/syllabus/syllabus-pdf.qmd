...
coursecode: "ECON 326 Spring 2023"
section: 1
author: Dr. Ryan Safner
semester: "[tradeS23.classes.ryansafner.com](http://tradeS23.classes.ryansafner.com)"
...
Your final course grade is the weighted average of the following assignments. You can find general descriptions for all the assignments on the [assignments page](https://tradeS23.classes.ryansafner.com/assignments/) and more specific information and examples on each assignment's page on the [schedule page](https://tradeS23.classes.ryansafner.com/schedule/).
...
Watch the excellent and accurate video explaining office hours [on the website](https:/trades23.classes.ryansafner.com/syllabus/#communication-email-slack-and-virtual-office-hours).
...
**You can find a full schedule** with much more details, including the readings, appendices, and other further resources for each class meeting on the [schedule page](https://tradeS23.classes.ryansafner.com/schedule/).
