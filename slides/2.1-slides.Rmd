...
- U.S. deadweight loss (A+B) $<$ U.S. tariff revenue (.hi-green[C]+.hi-purple[D])
...
- Welfare changes:
  - To US: (.hi-green[C]+.hi-purple[D])-(**A**+**B**), net gain!
  - To Rest of World: -(.hi-purple[D]+**E**), net loss
  - Whole World: .hi-green[C]-(**A**+**B**+**E**), net loss
...
- For a large country, a tariff decreases volume of trade but improves country’s terms of trade
  - Gain of tariff revenue (.hi-green[C]+.hi-purple[D])
